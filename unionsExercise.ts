...
const stuff: Array<number> | Array<string> = ['cellphone', 'alexa', 'microphone'];
// **********************************************
// ******************* PART 3 *******************
// **********************************************
...
const colors: Array<(RGB | HSL)> = [];
// **********************************************
// ******************* PART 6 *******************
// **********************************************
// Write a function called greet that accepts a single string OR an array of strings
// It should print "Hello, <name>" for that single person OR greet each person in the array with the same format
const greet = (name: string, names: Array<string>) => {
  const isSingleName = typeof(name) === 'string';
  const isManyNames = Array.isArray(names);
